            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="footer-about-us">
                        <h2 style="font-family:Impact;">TÀI<span>CÚC</span></h2>
                       <address>
                        <span>Chuyên cung cấp các sản phẩm công nghệ!</span>
                        <p><i class="fa fa-phone"></i> +84 326.935.389</p>
                        <p><i class="fa fa-map-marker"></i> Trường Đại học Công Nghệ Thông Tin Và Truyền Thông Thái Nguyên.</p>
                    </address>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy;2023 By Hải Sơn <a href="index.php" target="_blank">Tài Cúc</a></p>
                    </div>
                </div>
                <div class="col-md-4">
